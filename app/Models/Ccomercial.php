...
class Ccomercial extends Model
{
    ...
    protected $fillable=['centrocomercial',	
    'imagen', 
    'telefono', 
    'correo', 
    'municipio', 
...
protected $allowIncluded = ['centroscomerciales', 'lugarturistico']; // Lista con las posibles relaciones que podemos enviar a travez de la URL

    protected $allowFilter = ['id', 'imagen','centrocomercial', 'municipio'];

    protected $allowSort = ['id', 'imagen', 'centrocomercial', 'municipio'];
