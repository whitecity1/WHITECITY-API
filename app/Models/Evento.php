...
{
    use HasFactory;
    protected $fillable =['evento', 'municipio', 'direccion', 'horarios', 'fecha_inicio', 'fecha_fin', 'descripcion', 'tipo_evento', 'imagen', 'user_id'];

    protected $allowIncluded = ['users', 'convenios']; // Lista con las posibles relaciones que podemos enviar a travez de la U
   
    protected $allowFilter = ['id', 'evento', 'municipio'];

    protected $allowSort = ['id', 'evento', 'municipio'];
