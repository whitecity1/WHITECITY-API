...
class Hotel extends Model
{
    ...
    protected $allowIncluded = ['hoteles', 'lugarturistico']; // Lista con las posibles relaciones que podemos enviar a travez de la URL

    protected $allowFilter = ['id', 'hotel', 'mun_ubicado', 'direccion'];

    protected $allowSort = ['id', 'hotel', 'mun_ubicado', 'direccion'];
