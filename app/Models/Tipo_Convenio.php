...
class Tipo_Convenio extends Model
{
    ...
    protected $allowIncluded = ['tipo_convenios','convenios']; // Lista con las posibles relaciones que podemos enviar a travez de la URL

    protected $allowFilter = ['id', 'convenio', 'anotaciones'];

    protected $allowSort = ['id', 'convenio', 'anotaciones'];
