...
class Restaurante extends Model
{
    ...
    protected $allowIncluded = ['restaurantes', 'lugarturistico']; // Lista con las posibles relaciones que podemos enviar a travez de la URL

    protected $allowFilter = ['id', 'restaurante', 'mun_ubicado','direccion'];

    protected $allowSort = ['id', 'restaurante', 'mun_ubicado','direccion'];
