...
class Recomendado extends Model
{
    ...
    protected $allowIncluded = ['users']; // Lista con las posibles relaciones que podemos enviar a travez de la URL

    protected $allowFilter = ['id', 'lugar_recomendado', 'resenahistorica'];

    protected $allowSort = ['id', 'lugar_recomendado', 'resenahistorica'];
